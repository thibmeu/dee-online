const en_US = {
  ...
  offline_note: "Files are not uploaded to a server, everything is done in your browser.",
  ...
  enter_time_enc: "Enter decryption time",
  your_time_enc: "Time the file can be decrypted from",
  ...
  testing_date: "Testing Timelock date...",
  ...
  confirm_tlock_dec: "Confirm decryption parameters",
  ...
  file_has_early_date: "has wrong timelock date, make sure it's not too early to decrypt.",
